...
Require Export ExtendedBase.Fsub_LetSum_Lemmas.
...
Proof with eauto.
  ...
  eapply subqual_lift_elem; [|lattice]...
  eapply subqual_lift_elem; [|lattice]...
Qed.
...
Proof with simpl_env; auto.
  ...
  * dependent induction QsubT...
    - exfalso; apply nontrivial...
    - eapply subqual_eval_elim with (Q' := Q') (b := b)...
    - eapply subqual_eval_intro with (Q' := Q')...
      assumption.
    - replace b2 with top in *...
      eapply lattice_gt_top...
  * eapply subqual_eval_elim with (Q' := Q')...
    assumption.
  * eapply IHSsubQ2...
    eapply subqual_eval_intro with (Q' := Q') (b := b)...
    eapply subqual_reflexivity...
  * dependent induction QsubT...
    - apply lattice_lt_bot in H0. rewrite <- H0...
    - eapply subqual_eval_elim with (Q' := Q') (b := b)...
      eapply IHQsubT1... assumption.
    - eapply subqual_eval_intro with (Q' := Q') (b := b)...
      eapply IHQsubT2... assumption.
    - eapply subqual_lift_elem...
      eapply transitivity with (y := b2)...
    - eapply subqual_join_inl...
      eapply IHQsubT... assumption.
  ...
  * remember (qua_meet R1 R2) as R.
    ...
    - eapply subqual_eval_elim with (b := b) (Q' := Q')...
    - eapply subqual_eval_intro with (b := b) (Q' := Q')...
Qed.
